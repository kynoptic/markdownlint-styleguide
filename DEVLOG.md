...
- Batched the four open Renovate dev-tooling updates into one lockfile regeneration rather than four conflicting merges, the way #273-#277 were handled: prettier 3.9.4 to 3.9.6, eslint 10.6.0 to 10.10.0, globals 17.7.0 to 17.12.0, and lint-staged 17.0.8 to 17.5.0. lint-staged 17.5.0 drops `listr2`, which removes 22 transitive packages from the lockfile; that accounts for the bulk of the diff and is the upstream change, not a pruning done here.
